...
from bear.utils import compat_bytes, compat_chr
...
class Address(object):
    ...
    def __init__(self, address=None, pubkey=None, prefix="SHR"):
        self.prefix = prefix
...
class PublicKey(object):
    ...
    def __init__(self, pk, prefix="SHR"):
        self.prefix = prefix
...
class PrivateKey(object):
    ...
    def __init__(self, wif=None, prefix="SHR"):
        if wif is None:
            import os
