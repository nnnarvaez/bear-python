...
from bearbase.exceptions import (
    PostDoesNotExist,
    VotingInvalidOnArchivedPost,
)
from bearbase.operations import CommentOptions
...
class Post(dict):
    """ This object gets instantiated by Bear.streams and is used as an
        abstraction layer for Comments in Bear
        ...
        Args:
            ...
            beard_instance (Beard): Beard node to connect to

    """

    def __init__(self, post, beard_instance=None):
        self.beard = beard_instance or shared_beard_instance()
        self.commit = Commit(beard_instance=self.beard)
    ...
    def refresh(self):
        ...
        post = self.beard.get_content(post_author, post_permlink)
    ...
    def get_replies(self):
        ...
        """
        post_author, post_permlink = resolve_identifier(self.identifier)
        replies = self.beard.get_content_replies(post_author, post_permlink)
    ...
    def export(self):
        ...
        # Remove Bear instance object
        safe_dict = remove_from_dict(self, ['beard', 'commit'])
        ...
        op = CommentOptions(
            **{
                ...
                "percent_bear_dollars":
                    int(
                        options.get("percent_bear_dollars",
                                    self["percent_bear_dollars"] / 100) * 100),
                "allow_votes":
